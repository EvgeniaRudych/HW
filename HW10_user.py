...
# протестує чи зможе робот з певними вхідними даними закінчити прибирання
...
#якщо юзер створений то назад отримуємо строку "200",
# інакше модуль реєстрації кидатиме ексепшини (ексепшини потрібно написати свої)

#tести до модуля авторизації юзера
